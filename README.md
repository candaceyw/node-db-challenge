...
- [x] Explain the difference between `Relational Databases` and `SQL`.
      ...
      Relational Database: databases that store their data in tables.
      SQL: a language that is optimized for the sole purpse of querying data.
...
- [x] What do we need in order to have a _many to many_ relationship between two tables.
       ...
       You need an intermediary table that holds foreign keys that reference the primary key on the related tables.
